            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        if($upload==false)
                        {
                            $_SESSION['upload'] = "<div class='error'>Gagal Mengunggah Gambar baru.</div>";
                            header('location:'.SITEURL.'admin/manage-food.php');
                            die();
                        }
                        if($current_image!="")
                ...
                if($res3==true)
                {
                    $_SESSION['update'] = "<div class='success'>Menu Berhasil Diperbarui.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
                else
                {
                    $_SESSION['update'] = "<div class='error'>Gagal Memperbarui Menu.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
