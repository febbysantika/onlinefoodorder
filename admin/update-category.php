    ...
    <div class="wrapper">
        ...
        <?php 
            ...
            if(isset($_GET['id']))
            {
                ...
                {
                    $_SESSION['no-category-found'] = "<div class='error'>Kategori Tidak Tersedia.</div>";
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            {
                                // Menampilkan pesan jika gambar tidak ada
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        if($upload == false)
                        {
                            $_SESSION['upload'] = "<div class='error'>Gagal Mengunggah Gambar. </div>";
                            header('location:'.SITEURL.'admin/manage-category.php');
                            die();
                        }
                        ...
                        if($current_image != "")
                        {
                            ...
                            if($remove == false)
                            {
                                $_SESSION['failed-remove'] = "<div class='error'>Gagal menghapus Gambar saat ini.</div>";
                                header('location:'.SITEURL.'admin/manage-category.php');
                                die();
                            }
                        }
